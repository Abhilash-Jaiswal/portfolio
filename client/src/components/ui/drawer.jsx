...
function DrawerDescription({
  ...
  return (
    <DrawerPrimitive.Description
      ...
      className={cn("text-base text-balance text-muted-foreground", className)}
      {...props} />
  );
}
