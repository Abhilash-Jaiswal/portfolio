...
const principles = [
  { icon: "🤝", grad: "from-violet-500 to-purple-600", title: "Open & Inclusive", desc: "No dietary ideology pushed. All approaches welcomed. Women are treated as intelligent, empowered adults capable of making their own decisions." },
  { icon: "💬", grad: "from-green-500 to-emerald-600", title: "WhatsApp-First", desc: "85–95% open rates versus 22% for email. Meeting women where they already are — on the platform they use every day." },
  { icon: "✨", grad: "from-amber-400 to-orange-500", title: "Aspirational Identity", desc: "Visual and verbal identity shows women thriving — travelling solo, trekking, active and vibrant at midlife. Not victims. Champions." },
  { icon: "🇮🇳", grad: "from-rose-500 to-pink-600", title: "India-Specific", desc: "Content, case studies, food references, and expert voices tailored to Indian bodies, diets, and family dynamics. Not adapted from Western frameworks." },
  { icon: "🩺", grad: "from-teal-500 to-cyan-600", title: "Knowledge → Community → Doctors", desc: "Build trust through education, deepen through belonging, scale through clinical partnerships. The three-stage model of holistic support." },
];

const services = [
  {
    icon: "👩", grad: "from-fuchsia-500 to-pink-600",
  ...
  {
    icon: "🏢", grad: "from-violet-500 to-indigo-600",
  ...
  {
    icon: "🏫", grad: "from-teal-500 to-emerald-600",
...
export function NotPausedSection() {
  ...
  return (
    <section id="notpaused" ref={ref} className="bg-[#F7ECF2] border-b border-stone-200/60 scroll-mt-20">

      {/* ── HERO BANNER ── */}
      <div className="relative overflow-hidden bg-gradient-to-br from-fuchsia-700 via-pink-600 to-[#A054A6] py-28 px-6 md:px-12 lg:px-20">
        ...
        <div className="relative z-10 max-w-5xl animate-fade-in-up">
          ...
          <h1 className="font-serif text-4xl md:text-5xl lg:text-6xl text-white font-bold tracking-tight leading-[1.1] mb-6">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-white via-pink-200 to-fuchsia-200 animate-text-gradient">Menopause Platform</span>
          </h1>
      ...
      <div className="container mx-auto px-6 md:px-12 lg:px-20 py-20 space-y-20">
        ...
        {/* Problem Stat Banner */}
        <div className="reveal relative overflow-hidden rounded-3xl bg-gradient-to-r from-fuchsia-600 to-pink-600 p-10 text-white text-center shadow-xl">
        ...
        <div className="space-y-8">
          <div className="reveal flex flex-col md:flex-row md:items-center gap-4">
            <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-fuchsia-500 to-pink-600 flex items-center justify-center shadow-lg timeline-dot flex-shrink-0">
              <span className="text-2xl">💡</span>
            </div>
            <div>
              <span className="block text-[10px] font-bold tracking-[0.3em] uppercase text-fuchsia-500 mb-1">Chapter 01</span>
              <h2 className="font-serif text-2xl lg:text-3xl text-stone-900 font-bold">The Personal Origin</h2>
              <p className="text-stone-500 text-xs font-medium tracking-widest uppercase mt-1">Why a trained nutritionist found herself unprepared — and what she did about it</p>
            </div>
          </div>
          <div className="reveal pl-6 border-l-2 border-fuchsia-400 rounded-r-xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            {[
              ...
              <div key={i} className="reveal shimmer-card bg-white/80 border border-stone-200/60 p-7 rounded-3xl shadow-sm hover:shadow-lg hover:-translate-y-1 hover:border-fuchsia-300/50 transition-all duration-300" style={{ transitionDelay: `${i * 100}ms` }}>
                <h4 className="font-serif font-bold text-stone-900 text-base mb-3">{item.h}</h4>
                <p className="text-stone-600 text-sm font-light leading-relaxed text-justify">{item.b}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="space-y-8">
          <div className="reveal flex flex-col md:flex-row md:items-center gap-4">
            ...
            <div>
              <span className="block text-[10px] font-bold tracking-[0.3em] uppercase text-violet-500 mb-1">Chapter 02</span>
              <h2 className="font-serif text-2xl lg:text-3xl text-stone-900 font-bold">A Declaration, Not Just a Platform</h2>
              <p className="text-stone-500 text-xs font-medium tracking-widest uppercase mt-1">Why the name itself is a mission statement</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            {[
              ...
              <div key={i} className="reveal shimmer-card bg-white/80 border border-stone-200/60 p-7 rounded-3xl shadow-sm hover:shadow-lg hover:-translate-y-1 hover:border-violet-300/50 transition-all duration-300" style={{ transitionDelay: `${i * 100}ms` }}>
                <h4 className="font-serif font-bold text-stone-900 text-base mb-3">{item.h}</h4>
                <p className="text-stone-600 text-sm font-light leading-relaxed text-justify">{item.b}</p>
              </div>
            ))}
        ...
        <div>
          <div className="reveal text-center mb-12">
            <div className="inline-block border-t-[3px] border-fuchsia-500 pt-2 mb-4">
              <span className="text-fuchsia-600 font-bold text-sm tracking-[0.2em] uppercase">Three Verticals, One Mission</span>
            </div>
            <h3 className="font-serif text-2xl lg:text-3xl text-stone-900 font-bold">Who notpaused.com Serves</h3>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {services.map((s, i) => (
              <div key={i} className="reveal shimmer-card bg-white/80 border border-stone-200/60 p-8 rounded-3xl shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 space-y-5" style={{ transitionDelay: `${i * 100}ms` }}>
                <div className={`w-14 h-14 rounded-2xl bg-gradient-to-br ${s.grad} flex items-center justify-center text-2xl shadow-md timeline-dot`}>{s.icon}</div>
                <h4 className="font-serif font-bold text-stone-900 text-lg">{s.title}</h4>
                <ul className="space-y-2">
                  {s.items.map((item, j) => (
                    <li key={j} className="flex items-start gap-2 text-stone-600 text-sm font-light">
                      <span className="text-fuchsia-500 mt-0.5 flex-shrink-0">✦</span>
                      {item}
                    </li>
                  ))}
                </ul>
        ...
        <div>
          <div className="reveal text-center mb-10">
            <div className="inline-block border-t-[3px] border-[#A054A6] pt-2 mb-4">
              <span className="text-[#A054A6] font-bold text-sm tracking-[0.2em] uppercase">Platform Principles</span>
            </div>
            <h3 className="font-serif text-2xl lg:text-3xl text-stone-900 font-bold">What Makes notpaused.com Different</h3>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-5">
            {principles.map((p, i) => (
              <div key={i} className="reveal shimmer-card bg-white/80 border border-stone-200/60 p-6 rounded-3xl shadow-sm hover:shadow-xl hover:-translate-y-1 hover:border-fuchsia-300/40 transition-all duration-300 space-y-3" style={{ transitionDelay: `${i * 80}ms` }}>
                <div className={`w-12 h-12 rounded-2xl bg-gradient-to-br ${p.grad} flex items-center justify-center text-xl shadow-md`}>{p.icon}</div>
        ...
        {/* City Chapters */}
        <div className="reveal bg-white/80 border border-stone-200/60 p-8 rounded-3xl shadow-sm text-center space-y-5">
          <span className="text-fuchsia-600 font-bold text-xs tracking-widest uppercase block">WhatsApp-Native Community Chapters</span>
          <p className="text-stone-700 text-sm font-light max-w-2xl mx-auto">City chapters ensure local relevance — local doctors, local foods, local conversations — combined with the scale and warmth of a national community.</p>
          <div className="flex flex-wrap justify-center gap-3">
            {cityChapters.map((city) => (
              <span key={city} className="bg-gradient-to-r from-fuchsia-50 to-pink-50 text-fuchsia-700 text-xs font-semibold px-4 py-2 rounded-full border border-fuchsia-200/60 hover:bg-fuchsia-100 transition-colors">
                📍 {city}
              </span>
            ))}
          </div>
        ...
        {/* Closing Quote */}
        <div className="reveal relative overflow-hidden rounded-3xl bg-gradient-to-br from-fuchsia-700 via-pink-600 to-[#A054A6] p-10 lg:p-14 text-center shadow-2xl">
