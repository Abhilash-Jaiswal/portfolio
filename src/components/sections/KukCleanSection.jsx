...
const products = [
  { icon: "🍬", grad: "from-[#A863AD] to-[#8E4C93]", title: "Healthy Indian Sweets", desc: "Traditional laddus, bars, bites & festive treats — 100% plant-based, no refined sugar, no dairy. Reimagined for the modern Indian family without sacrificing a single gram of flavour." },
  { icon: "🥨", grad: "from-[#A863AD] to-[#8E4C93]", title: "Healthy Snacks", desc: "Baked and slow-roasted alternatives to deep-fried, sodium-laden Indian snacking. Crunch without compromise — designed for the desk, the commute, and the classroom." },
  { icon: "🥜", grad: "from-[#A863AD] to-[#8E4C93]", title: "Dips, Spreads & Nut Butters", desc: "Stone-ground to preserve natural oils and micronutrients that commercial processing destroys. Real ingredients. Nothing hidden." },
  { icon: "🥣", grad: "from-[#A863AD] to-[#8E4C93]", title: "Breakfast Cereals", desc: "Millet and whole-grain options bringing the nutritional power of ancient grains into modern mornings. A clean, energising start — every single day." },
  { icon: "🎁", grad: "from-[#A863AD] to-[#8E4C93]", title: "Gifting & Travel Ranges", desc: "Thoughtfully packaged hampers and travel-friendly portions — clean eating on the road or as a meaningful gift that actually reflects your values." },
];

const audience = [
  { icon: "👨‍👩‍👧", grad: "from-[#A863AD] to-[#8E4C93]", title: "Health-Conscious Indian Families", desc: "Especially mothers making food decisions for their children — seeking nutrient-dense, transparent alternatives to what the supermarket offers." },
  { icon: "🌱", grad: "from-[#A863AD] to-[#8E4C93]", title: "Vegan & Plant-Based Community", desc: "A rapidly growing, underserved demographic seeking genuine 100% plant-based, clean-label foods that don't compromise on taste or culture." },
  { icon: "🏃‍♀️", grad: "from-[#A863AD] to-[#8E4C93]", title: "Fitness & Wellness Practitioners", desc: "Those who deeply understand the food-performance relationship and require clean, uncompromised fuel — before, during, and after training." },
  { icon: "❤️", grad: "from-[#A863AD] to-[#8E4C93]", title: "Lifestyle Disease Management", desc: "Individuals managing diabetes, obesity, cardiovascular health, and hypertension through food choices — not just pharmaceuticals." },
  { icon: "🌏", grad: "from-[#A863AD] to-[#8E4C93]", title: "Diaspora & NRI Communities", desc: "Seeking authentic Indian tastes made with uncompromised, clean, premium ingredients that honour both culture and health." },
];
...
export function KukCleanSection() {
  ...
  return (
    <section id="kuk-clean" ref={ref} className="bg-[#FAF8FB] border-b border-[#E5DCE8]/60 scroll-mt-20">
      ...
      <div className="relative overflow-hidden bg-gradient-to-br from-[#A863AD] via-[#8E4C93] to-[#7F4484] py-28 px-6 md:px-12 lg:px-20">
        ...
        <div className="relative z-10 max-w-5xl animate-fade-in-up">
          ...
          <h1 className="font-serif text-4xl md:text-5xl lg:text-6xl text-white font-bold tracking-tight leading-[1.1] mb-6">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-white via-pink-200 to-[#E7C9E8] animate-text-gradient">Unapologetically Delicious.</span>
          </h1>
      ...
      <div className="container mx-auto px-6 md:px-12 lg:px-20 py-20 space-y-20">
        ...
        <div className="space-y-8">
          <div className="reveal flex flex-col md:flex-row md:items-center gap-4">
            ...
            <div>
              ...
              <h2 className="font-serif text-2xl lg:text-3xl text-[#2E2433] font-bold">The Kitchen Standard</h2>
              <p className="text-[#6F6476] text-xs font-medium tracking-widest uppercase mt-1">How KuK Clean's quality was defined — one daughter's reaction at a time</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            <div className="reveal shimmer-card bg-white/80 border border-[#E5DCE8]/60 p-7 rounded-3xl shadow-sm hover:shadow-lg hover:-translate-y-1 hover:border-[#A863AD]/30 transition-all duration-300">
              <h4 className="font-serif font-bold text-[#2E2433] text-base mb-3 hover:text-[#A863AD]">The Unglamorous Early Days</h4>
              <p className="text-[#6F6476] text-sm font-light leading-relaxed text-justify">
            ...
            <div className="reveal shimmer-card bg-white/80 border border-[#E5DCE8]/60 p-7 rounded-3xl shadow-sm hover:shadow-lg hover:-translate-y-1 hover:border-[#A863AD]/30 transition-all duration-300" style={{ transitionDelay: "100ms" }}>
              <h4 className="font-serif font-bold text-[#2E2433] text-base mb-3">Growth Built on Trust</h4>
              <p className="text-[#6F6476] text-sm font-light leading-relaxed text-justify">
        ...
        <div className="space-y-8">
          <div className="reveal flex flex-col md:flex-row md:items-center gap-4">
            ...
            <div>
              ...
              <h2 className="font-serif text-2xl lg:text-3xl text-[#2E2433] font-bold">Millets, Science & National Recognition</h2>
              <p className="text-[#6F6476] text-xs font-medium tracking-widest uppercase mt-1">From kitchen innovation to government-recognised agritech — ICAR-IIMR & Nutrihub</p>
            </div>
          </div>
          <div className="reveal pl-6 border-l-2 border-[#A863AD] rounded-r-xl">
            <p className="text-[#6F6476] text-base font-light leading-relaxed">
          ...
          <div className="reveal bg-[#F4EFF6] border border-[#E5DCE8] rounded-3xl p-8">
            <p className="text-[#6F6476] text-sm font-light leading-relaxed text-justify">
        ...
        <div className="space-y-8">
          <div className="reveal flex flex-col md:flex-row md:items-center gap-4">
            ...
            <div>
              ...
              <h2 className="font-serif text-2xl lg:text-3xl text-[#2E2433] font-bold">Corporate Wellness & B2B Consulting</h2>
              <p className="text-[#6F6476] text-xs font-medium tracking-widest uppercase mt-1">Taking clean nutrition into boardrooms, cafeterias, and institutions</p>
            </div>
          </div>
          <div className="reveal pl-6 border-l-2 border-[#A863AD] rounded-r-xl">
            <p className="text-[#6F6476] text-base font-light leading-relaxed">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
            {b2bVerticals.map((v, i) => (
              <div key={i} className="reveal shimmer-card bg-white/80 border border-[#E5DCE8]/60 p-6 rounded-3xl shadow-sm hover:shadow-lg hover:-translate-y-1 hover:border-[#A863AD]/30 transition-all duration-300 space-y-3" style={{ transitionDelay: `${i * 80}ms` }}>
                <div className="w-10 h-10 rounded-full chapter-tag-gradient flex items-center justify-center text-lg text-white font-bold">{v.icon}</div>
                <span className="text-[10px] font-bold tracking-widest text-[#A863AD] uppercase block">Vertical {v.num}</span>
                <h4 className="font-serif font-bold text-[#2E2433] text-sm">{v.title}</h4>
                <p className="text-[#6F6476] text-xs font-light leading-relaxed">{v.desc}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div>
          <div className="reveal text-center mb-10">
            <div className="inline-block border-t-[3px] border-[#A863AD] pt-2 mb-4">
              <span className="text-[#A863AD] font-bold text-sm tracking-[0.2em] uppercase">Product Portfolio</span>
            </div>
            <h3 className="font-serif text-2xl lg:text-3xl text-[#2E2433] font-bold">Five Lines, One Standard</h3>
          </div>
        ...
        <div>
          <div className="reveal text-center mb-10">
            <div className="inline-block border-t-[3px] border-[#A863AD] pt-2 mb-4">
              <span className="text-[#A863AD] font-bold text-sm tracking-[0.2em] uppercase">Target Audience</span>
            </div>
            <h3 className="font-serif text-2xl lg:text-3xl text-[#2E2433] font-bold">Who KuK Clean is For</h3>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-5">
            {audience.map((a, i) => (
              <div key={i} className="reveal shimmer-card bg-white/80 border border-[#E5DCE8]/60 p-6 rounded-3xl shadow-sm hover:shadow-xl hover:-translate-y-1 hover:border-[#A863AD]/30 transition-all duration-300 space-y-3" style={{ transitionDelay: `${i * 80}ms` }}>
                ...
                <h4 className="font-serif font-bold text-[#2E2433] text-sm">{a.title}</h4>
                <p className="text-[#6F6476] text-xs font-light leading-relaxed">{a.desc}</p>
              </div>
            ))}
          </div>
        </div>
