      ...
      <div className="container mx-auto px-6 md:px-12 lg:px-20 text-center">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto border-t border-stone-200 pt-16">
          <div className="flex flex-col items-center group cursor-pointer">
            <div className="w-16 h-16 rounded-full border border-stone-200 flex items-center justify-center mb-4 group-hover:border-[#FF5C58] group-hover:bg-[#FF5C58]/5 group-hover:scale-110 shadow-sm transition-all duration-300 bg-white/80">
              <span className="font-serif text-xl text-stone-400 group-hover:text-[#FF5C58] transition-colors">In</span>
            </div>
          ...
          <div className="flex flex-col items-center group cursor-pointer">
            <div className="w-16 h-16 rounded-full border border-stone-200 flex items-center justify-center mb-4 group-hover:border-[#FF5C58] group-hover:bg-[#FF5C58]/5 group-hover:scale-110 shadow-sm transition-all duration-300 bg-white/80">
              <span className="font-serif text-xl text-stone-400 group-hover:text-[#FF5C58] transition-colors">Yt</span>
            </div>
          ...
          <div className="flex flex-col items-center group cursor-pointer">
            <div className="w-16 h-16 rounded-full border border-stone-200 flex items-center justify-center mb-4 group-hover:border-[#FF5C58] group-hover:bg-[#FF5C58]/5 group-hover:scale-110 shadow-sm transition-all duration-300 bg-white/80">
              <span className="font-serif text-xl text-stone-400 group-hover:text-[#FF5C58] transition-colors">Li</span>
            </div>
          ...
          <div className="flex flex-col items-center group cursor-pointer">
            <div className="w-16 h-16 rounded-full border border-stone-200 flex items-center justify-center mb-4 group-hover:border-[#FF5C58] group-hover:bg-[#FF5C58]/5 group-hover:scale-110 shadow-sm transition-all duration-300 bg-white/80">
              <span className="font-serif text-xl text-stone-400 group-hover:text-[#FF5C58] transition-colors">Wa</span>
            </div>
