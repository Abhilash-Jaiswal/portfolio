...
export function IntroductionSection() {
  ...
  return (
    <section id="introduction-details" className="py-24 bg-[#F7ECF2] border-b border-stone-200/60 scroll-mt-20">
      <div className="container mx-auto px-6 md:px-12 lg:px-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 mb-20 items-center">
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="border-l-2 border-[#A054A6] pl-6 my-6 italic text-stone-850 font-serif text-base leading-relaxed">
              ...
              {coreIdentity.map((id, idx) => (
                <div key={idx} className="flex gap-4 items-start pb-3 border-b border-stone-155 last:border-b-0 last:pb-0">
                  ...
                  <div>
                    ...
                    <span className="text-stone-850 font-medium text-sm lg:text-base">{id.value}</span>
                  </div>
                </div>
              ))}
            </div>
          ...
          <div className="flex border-b border-stone-200 mb-8 justify-center lg:justify-start">
            <button
              ...
              className={`pb-4 px-6 font-bold text-sm tracking-wider uppercase transition-all border-b-2 cursor-pointer ${
                activeTab === "philosophy" ? "border-[#A054A6] text-[#A054A6]" : "border-transparent text-stone-500 hover:text-stone-805"
              }`}
            >
              Core Philosophy
            </button>
            <button
              ...
              className={`pb-4 px-6 font-bold text-sm tracking-wider uppercase transition-all border-b-2 cursor-pointer ${
                activeTab === "mission" ? "border-[#A054A6] text-[#A054A6]" : "border-transparent text-stone-500 hover:text-stone-805"
              }`}
            >
              Core Mission
            </button>
            ...
            {activeTab === "philosophy" ? (
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="space-y-3">
                  <div className="w-10 h-10 rounded-full bg-[#A054A6]/10 flex items-center justify-center text-[#A054A6] font-bold text-base">01</div>
                  <h4 className="font-serif font-bold text-stone-900 text-base">Health is a Daily Choice</h4>
                  <p className="text-stone-500 text-sm leading-relaxed font-light">Health is a consistent, daily practice of conscious, nourishing choices—never a destination reached through shortcuts or quick-fix synthetic supplements.</p>
                </div>
                <div className="space-y-3">
                  <div className="w-10 h-10 rounded-full bg-[#A054A6]/10 flex items-center justify-center text-[#A054A6] font-bold text-base">02</div>
                  <h4 className="font-serif font-bold text-stone-900 text-base">Clean-Label Standards</h4>
                  <p className="text-stone-500 text-sm leading-relaxed font-light">We advocate for clean-label, plant-based nutrition at KuK Clean and apply a deeply inclusive, evidence-based, non-prescriptive approach at notpaused.com.</p>
                </div>
                <div className="space-y-3">
                  <div className="w-10 h-10 rounded-full bg-[#A054A6]/10 flex items-center justify-center text-[#A054A6] font-bold text-base">03</div>
                  <h4 className="font-serif font-bold text-stone-905 text-base">Empathy & Warmth</h4>
                  <p className="text-stone-500 text-sm leading-relaxed font-light">We meet individuals exactly where they are in their wellness journeys—free from rigid rules, dietary dogma, or any compromise on personal warmth.</p>
                </div>
              </div>
            ) : (
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="space-y-3">
                  <div className="w-10 h-10 rounded-full bg-[#A054A6]/10 flex items-center justify-center text-[#A054A6] font-bold text-base">01</div>
                  <h4 className="font-serif font-bold text-stone-900 text-base">Democratizing Clean Food</h4>
                  <p className="text-stone-500 text-sm leading-relaxed font-light">Through KuK Clean Wellness, we democratize plant-based food systems, proving that nutrient-dense, clean food can be exceptionally delicious.</p>
                </div>
                <div className="space-y-3">
                  <div className="w-10 h-10 rounded-full bg-[#A054A6]/10 flex items-center justify-center text-[#A054A6] font-bold text-base">02</div>
                  <h4 className="font-serif font-bold text-stone-900 text-base">Dismantling Taboos</h4>
                  <p className="text-stone-500 text-sm leading-relaxed font-light">Through notpaused.com, we dismantle the last great taboo in Indian women's health—menopause—providing clinical-level guidance and community support.</p>
                </div>
                <div className="space-y-3">
                  <div className="w-10 h-10 rounded-full bg-[#A054A6]/10 flex items-center justify-center text-[#A054A6] font-bold text-base">03</div>
                  <h4 className="font-serif font-bold text-stone-900 text-base">Systemic Access</h4>
                  <p className="text-stone-500 text-sm leading-relaxed font-light">Ensuring that every Indian woman, regardless of demographic or background, has open access to nourishing food, honest health information, and deep community.</p>
                </div>
              </div>
            )}
          </div>
        ...
        <div className="bg-[#A054A6] rounded-3xl p-8 lg:p-12 text-white mb-20 relative overflow-hidden shadow-xl shadow-red-950/10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-20 items-stretch">
          ...
          <div className="lg:col-span-6 bg-white/60 border border-stone-200/50 p-8 rounded-3xl shadow-sm">
            ...
            <ul className="space-y-4">
              {credentials.map((cred, idx) => (
                <li key={idx} className="flex gap-3 text-sm text-stone-650 leading-relaxed font-light">
                  <span className="text-[#A054A6] font-bold">✓</span>
                  <span>{cred}</span>
                </li>
              ))}
            </ul>
          ...
          <div className="lg:col-span-6 bg-white/60 border border-stone-200/50 p-8 rounded-3xl shadow-sm flex flex-col justify-between">
            <div>
              ...
              <p className="text-stone-500 text-sm font-light tracking-widest uppercase mb-6 block">
            ...
            <div className="mt-8 p-4 rounded-xl bg-[#F7ECF2]/50 border border-stone-200 text-center">
              <span className="text-stone-500 text-[10px] font-bold tracking-widest uppercase block mb-1">Differentiator</span>
              <p className="text-stone-850 text-sm font-medium font-serif leading-relaxed">
        ...
        <div className="border-t border-stone-200/60 pt-20">
          <div className="text-center mb-12">
            ...
            <p className="text-stone-500 text-sm font-light mt-2 uppercase tracking-widest">Scaling Systemic Change Across India</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-6 rounded-2xl bg-white border border-stone-200/60 shadow-sm flex flex-col justify-between hover:border-[#A054A6]/20 transition-all duration-300">
              <div className="space-y-3">
                <span className="text-stone-400 font-serif text-3xl font-extrabold block select-none">I</span>
                <h4 className="font-serif font-bold text-stone-900 text-base uppercase">KuK Clean Wellness</h4>
                <p className="text-stone-550 text-sm leading-relaxed font-light">
            ...
            <div className="p-6 rounded-2xl bg-white border border-stone-200/60 shadow-sm flex flex-col justify-between hover:border-[#A054A6]/20 transition-all duration-300">
              <div className="space-y-3">
                ...
                <h4 className="font-serif font-bold text-[#A054A6] text-base uppercase">notpaused.com</h4>
                <p className="text-stone-550 text-sm leading-relaxed font-light">
            ...
            <div className="p-6 rounded-2xl bg-white border border-stone-200/60 shadow-sm flex flex-col justify-between hover:border-[#A054A6]/20 transition-all duration-300">
              <div className="space-y-3">
                ...
                <h4 className="font-serif font-bold text-stone-900 text-base uppercase">Systemic Ambition</h4>
                <p className="text-stone-550 text-sm leading-relaxed font-light">
